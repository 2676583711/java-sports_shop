...
<body>
	<div class="box-positon">
		...
		<form class="ropt">
			<!-- v_list.shtml -->
			<input type="submit"
				onclick="this.form.action='/admin/brand/divide.do';" value="返回列表"
				class="return-button" />
		</form>
		<div class="clear"></div>
	</div>
					...
					<tr>
						...
						<td width="80%" class="pn-fcontent">
							<input type="text" class="required" name="description"
								maxlength="80" size="60" value="${brandBean.description }" />
						</td>
					</tr>
					<tr>
						<td width="20%" class="pn-flabel pn-flabel-h">排序:</td>
						<td width="80%" class="pn-fcontent">
							<input value="${brandBean.sort }" type="text" class="required"
								name="sort" maxlength="80" />
						</td>
					</tr>
					<tr>
