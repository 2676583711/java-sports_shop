...
<body>
	...
	<div class="w ofc mt">
		<div class="l">
			<div class="showPro">
				<div class="big">
					<a id="showImg" class="cloud-zoom" href="/res/img/pic/ppp0.jpg"
						rel="adjustX:10,adjustY:-1">
						<img alt="" src="/res/img/pic/ppp0.jpg">
					</a>
				</div>
			</div>
		</div>
		<div class="r" style="width: 640px">
			<ul class="uls form">
				<li>
					<h2>依琦莲2014瑜伽服套装新款 瑜珈健身服三件套 广场舞蹈服装 性价比最高的瑜伽服 三件套 送胸垫 支持货到付款</h2>
				</li>
				<li>
					<label>巴 巴 价：</label>
					<span class="word">
						<b class="f14 red mr">￥128.00</b>
						(市场价:
						<del>￥150.00</del>
						)
					</span>
				...
				<li>
					<label>库 存：</label>
					<span class="word" id="stockInventory">100</span>
					<span class="word">件</span>
				</li>
				<li>
					<label>选择颜色：</label>
					<div id="colors" class="pre spec">
						<a onclick="colorToRed(this,9)" href="javascript:void(0)"
							title="西瓜红" class="changToRed">
							<img width="25" height="25" data-img="1"
								src="/res/img/pic/ppp00.jpg" alt="西瓜红 ">
							<i>西瓜红</i>
						</a>
						<a onclick="colorToRed(this,11)" href="javascript:void(0)"
							title="墨绿" class="changToWhite">
							<img width="25" height="25" data-img="1"
								src="/res/img/pic/ppp00.jpg" alt="墨绿 ">
							<i>墨绿</i>
						</a>
						<a onclick="colorToRed(this,18)" href="javascript:void(0)"
							title="浅粉" class="changToWhite">
							<img width="25" height="25" data-img="1"
								src="/res/img/pic/ppp00.jpg" alt="浅粉 ">
							<i>浅粉</i>
						</a>
					</div>
				</li>
				...
				<li>
					...
					<input id="num" type="text" value="1" name="" size="1"
						readonly="readonly">
				...
				<li class="submit">
					<input type="button" value="" class="hand btn138x40"
						onclick="buy();" />
					<input type="button" value="" class="hand btn138x40b"
						onclick="addCart()" />
				</li>
			</ul>
		</div>
	...
	<div class="w ofc mt">
		...
		<div class="r wr">
			<h2 class="h2 h2_ch mt">
				<em>
					<a href="javascript:void(0);" title="商品介绍" rel="#detailTab1"
						class="here">商品介绍</a>
			...
			<div class="box bg_white ofc">
				<div id="detailTab1" class="detail">
					<img src="/res/img/pic/p800b.jpg" />
					<img src="/res/img/pic/p800a.jpg" />
					<img src="/res/img/pic/p800c.jpg" />
					<img src="/res/img/pic/p800d.jpg" />
				</div>

				<div id="detailTab2" style="display: none">
					<strong>服务承诺：</strong>
					<br>
					京东向您保证所售商品均为正品行货，京东自营商品开具机打发票或电子发票。凭质保证书及京东发票，可享受全国联保服务（奢侈品、钟表除外；奢侈品、钟表由京东联系保修，享受法定三包售后服务），与您亲临商场选购的商品享受相同的质量保证。京东还为您提供具有竞争力的商品价格和
					<a target="_blank" href="http://www.jd.com/help/kdexpress.aspx">运费政策</a>
					，请您放心购买！
					<br>
					<br>
