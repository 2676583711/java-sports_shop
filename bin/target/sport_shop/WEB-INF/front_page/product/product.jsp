...
//登陆
function login(){
	window.location.href = "../buyer/login.do";
}
</script>
</head>
<body>
			...
			<div class="mt ofc">
				<ul class="uls i_150x150 x4_150x150b">
					<li>
						...
						<dl>
							<!-- dt 10个文字+... -->
							<dt>
								<a href="productDetail.do" title="依琦莲2014瑜伽服套装新款"
									target="_blank">依琦莲2014瑜伽服套装新款</a>
							</dt>
							<!-- dt 25个文字+... -->
				...
				<div class="page pb15">
					<span class="r inb_a page_b">
						...
						<a href="javascript:void(0);" id="previous" title="上一页"
							style="display: none">
							<samp>&lt;&lt;</samp>
							上一页
						</a>
