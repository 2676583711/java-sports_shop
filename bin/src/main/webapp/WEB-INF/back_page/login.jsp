						...
						<tr>
							<td width="423" height="280" valign="top">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td>
											<img src="${base}/res/jeecms/img/login/ltop.jpg" />
										</td>
									</tr>
									<tr>
										<td>
											<img src="${base}/res/jeecms/img/login/llogo.jpg" />
										</td>
									</tr>
								</table>
							</td>
							<td width="40" align="center" valign="bottom">
								<img src="${base}/res/jeecms/img/login/line.jpg" width="23"
									height="232" />
							</td>
							<td valign="top">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td height="90" align="center" valign="bottom">
											<img src="${base}/res/jeecms/img/login/ltitle.jpg" />
										</td>
									</tr>
									<tr>
										<td>
											...
											<table width="100%" border="0" align="center" cellpadding="0"
												...
												<tr>
													<td width="91" height="40" align="right">
														<strong> <@s.m "login.username"/>ï¼</strong>
													</td>
													<td width="211">
												...
												<tr>
													<td height="40" align="right">
														<strong><@s.m "login.password"/>ï¼</strong>
													</td>
													<td>
												...
												<tr>
													<td height="40" align="right">
														<strong><@s.m "login.captcha"/>ï¼</strong>
													</td>
													<td>
														<input name="captcha" type="text" id="captcha"
															vld="{required:true}" class="input" />
													</td>
												</tr>
												</#if>
												<tr>
													<td height="40" colspan="2" align="center">
														<input type="image"
															src="${base}/res/jeecms/img/login/login.jpg"
															name="submit" />
														&nbsp; &nbsp;
