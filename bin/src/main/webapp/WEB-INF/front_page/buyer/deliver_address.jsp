					...
					<table cellspacing="0" summary="" class="tab tab6">
						...
						<tbody>
							<tr class="here">
								...
								<td>15321801196</td>
								<td>
									<a href="javascript:void(0);" title="修改" onclick="modify('1')"
										class="blue">[修改]</a>
									<a href="javascript:void(0);" title="删除" onclick="del(this)"
										class="blue">[删除]</a>
								</td>
							</tr>
							<tr>
					...
					<form id="jvForm" method="post">
						<ul class="uls form">
							...
							<li>
								...
								<span>
									<input type="checkbox" name="statusAddr" />
									设为默认收货地址
								</span>
							</li>
							<li>
